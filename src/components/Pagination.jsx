	...
	return (
		<ul
			className={classnames(
				"pagination-container flex justify-center w-full items-center gap-2",
				{ [className]: className }
			)}>
			...
			<div
				...
				} border py-[8px] px-[12px] hover:bg-[#002855] hover:text-white bg-white rounded-md`}>
				<li
						...
						<div
							...
							className={`${
								pageNumber === currentPage
									...
									: "bg-white"
							} border shadow-sm py-[8px] px-[14px] rounded-md hover:bg-[#002855] hover:text-white cursor-pointer flex items-center justify-center`}
			...
			<div
				...
				} border py-[8px] px-[12px] bg-white hover:bg-[#002855] hover:text-white rounded-md`}>
				<li
					className={classnames("pagination-ite", {
